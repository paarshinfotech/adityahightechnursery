...
if (isset($_POST['save_female_attendance'])) {
	if (save_female_attendance($_POST)) {
		header("Location: female_attendance?date={$today}");
		exit();
	}
}
?>
...
<div class="page-wrapper">
	<div class="page-content">
	    <h6 class="mb-0 text-uppercase">महिला हजेरी</h6
				...
				<table class="table table-bordered table-nowrap table-align-middle table-col-1-fixed-start shadow-end table-col-2-fixed-start-offset-1">
					<thead class="thead-light" align="center">
						...
						<tr>
							...
							<!--<th class="<?//= $day->is_totay ? 'bg-primary bg-opacity-25' : '' ?>"><?//= translate('paid_leave') ?> रोजगार</th>-->
							<?php endforeach ?>
						</tr>
					</thead>
					<tbody align="center">
						<?php $employees = get_employees_female() ?>
						...
						<tr>
							...
							<!--<td class="<?//= $day->is_totay ? 'bg-primary bg-opacity-25' : '' ?>">
							<!--	<input class="form-control text-center" type="text" oninput="allowType(event,'number')"-->
							<!--	<?php //if ($day->is_totay): ?>-->
							<!--		name="per_day[<?//= $employee->emp_id ?>]" -->
							<!--	<?php //else: ?>-->
							<!--		disabled-->
							<!--	<?php //endif ?>-->
							<!--	>-->
					...
					<tfoot class="thead-light">
						<tr>
							...
							<th colspan="2" class="<?= $day->is_totay ? 'bg-primary bg-opacity-25' : '' ?>">
								...
								<button type="submit" class="btn btn-primary btn-sm w-100" name="save_female_attendance">
									<?= translate('save') ?>
								</button>
								<?php endif ?>
							</th>
