...
@media print {
/*    .sidebar-wrapper, .left-sidebar, .topbar,.navbar,.footer, .page-titles, .btnprint{*/
                ...
                <div class="card card-body printableArea mt-2">
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                <img src="logo/invoice/lhead.png" alt="logo" width="100%">
                                <!--<h4 class="fw-bold">मो. <span class="text-nowrap fw-bold fs-4 text-dark mt-2">8055339604,9765969828,9765694691</span>-->
                                <!--</h4>-->
                            </div>
                        </div>
                    </div>
         ...
         <!--               <div class="col-1"></div>-->
					    ...
					    <div class="row mt-5">
					        <div class="col-1"></div>
					                ...
					                <div id="content">
                                    <div id="background">
                                         <img class="img" src="logo/invoice/glogo.png">
    	                            </div>
    	                            
                                        <div class="text-justify">
                                            <p><?=  html_entity_decode($invoice['letters'])?></p>
                                        </div>
                                    </div>
                                    <div class="col-1"></div>
                             </div>
                        ...
                        <div class="row">
                             ...
                             <div class="col-12">
                                 <div class="text-center">
                                <img class="foot" src="logo/invoice/lfoot.png" alt="logo" width="100%">
                                </div>
                             </div>
