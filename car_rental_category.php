...
<div class="page-wrapper">
	<div class="page-content">
		<h6 class="mb-0 text-uppercase">गाडी भाडे श्रेणी </h6>
            <a class="btn btn-sm btn-success float-end" href="car_rental_add" style="margin-top:-25px;">
                        ...
                        <div class="dataTables_length" id="suppliertbl_length">
                            <label style="display: inline-flex; align-items: center; gap: 5px; ">Show
                                <select name="suppliertbl_length" id="table_Row_Limit"
                                    onchange="ajaxCarRentCategory(1)" aria-controls="suppliertbl"
...
<script>
    function ajaxCarRentCategory(page = 1, search = '') {
...
function ChangePage(page){
	...
	ajaxCarRentCategory(page, inputValue )
}
</script>
...
<script>
    function logInputValueCustomer() {
        ...
        ajaxCarRentCategory(1, inputValue);
    }
</script>
