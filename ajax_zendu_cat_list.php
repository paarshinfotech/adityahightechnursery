...
<?php
        ...
        $sql = "SELECT COUNT(*) AS total_rows FROM marigold_category WHERE cat_status = '1' " . $SQL_Filter_Query . " ;";
        ...
        if (($totalRows < 1)) {
            ...
            // echo "SELECT * FROM marigold_category c  plant_type p ON c.pt_id = p.pt_id WHERE c.cat_status = '1' AND " . $SQL_Filter_Query . " ORDER BY c.cat_id DESC " . $SQL_ROW_Query . " ;"
                ?>
...
<table border="1" id="example2" class="table table-striped table-bordered table-hover multicheck-container">
                ...
                <div class="d-inline-flex align-items-center select-all">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="category-action">
                            <li>
                                <a title="झेंडू श्रेणी हटवा" class="multi-action-btn dropdown-item text-danger"
                                    data-multi-action="delete" data-multi-action-page="" href="#"
                                    onclick="performDelete('ZENDUCATEGORY', 1, '#delete_check_box', ajaxZanduCategoryData)">
    ...
    <tbody>
        ...
        <?php $getBrand = mysqli_query($connect, "SELECT * FROM marigold_category c JOIN plant_type p ON c.pt_id = p.pt_id WHERE c.cat_status = '1' " . $SQL_Filter_Query . " ORDER BY c.cat_id DESC  " . $SQL_ROW_Query . " ;") ?>
        ...
        <tr>
            <td class="form-group">
                <input type="checkbox" class="multi-check-item " id="delete_check_box" name="cat_id[]"
                    value="<?= $cat_id ?>">
