...
Aditya::subtitle('सर्व विक्री');

$from = isset($_GET['date-from']) ? date('Y-m-d', strtotime($_GET['date-from'])) : date('Y-m-d');
$to = isset($_GET['date-to']) ? date('Y-m-d', strtotime($_GET['date-to'])) : date('Y-m-d', strtotime("{$from} + 1 day"));
