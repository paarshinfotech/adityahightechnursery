...
//restore 
if (isset($_GET['restore']) && isset($_GET['customer_id'])){
    escapePOST($_GET);
    ...
    // }
     $delete = mysqli_query($connect, "UPDATE customer SET customer_status='1' WHERE customer_id='{$dir}'");
    }
        if($delete){
    	header("Location: customer_list?action=Success&action_msg=ग्राहक पुनर्संचयित  केले..!");
		exit();
        }else{
			...
			<div class="card-body">
				 ...
				 <div class="table-responsive">
					<table border="1" id="example2" class="table table-striped table-bordered table-hover multicheck-container">
			                            ...
			                            <div class="dropdown">
			                            	...
			                            	<ul class="dropdown-menu" aria-labelledby="category-action" style="margin: 0px; position: absolute; inset: 0px auto auto 0px; transform: translate(0px, 35px);">
			                            		<li>
			                            			...
			                            			<li>
			                            			<a title="ग्राहक हटवा" class="multi-action-btn dropdown-item text-danger" data-multi-action="delete" data-multi-action-page="" href="?delete=true" onclick="return confirm('ग्राहक हटवा..?');">
						...
						<tbody>
                            <?php $getBrand = mysqli_query($connect, "SELECT * FROM customer WHERE customer_status='0' ORDER BY customer_id DESC") ?>
