...
if (isset($_GET['jcb_id']) && isset($_GET['adv_id'])){
$carList = array();
$getCar = "select * from jcb c,jcb_adv a WHERE a.cr_id='{$_GET['jcb_id']}' AND c.jcb_id=a.cr_id";
            ...
            <div class="col-md-12">
                ...
                <div class="card card-body printableArea mt-1">
                    ...
                    <div class="row justify-content-end mt-3 text-center">
						    ...
						    <div class="col-6">
							    <h6 class="fw-bold">दि.: <?php $date=date('d M Y',strtotime($jdate))?>
                                            <?= $date?></h6>
						    </div>
					    </div>
                                ...
                                <div id="background">
    	                            ...
    	                            <div class="col-12 my-0 py-2 max-h-500 oy-auto">
						        		...
						        		<table class="table">
						        			...
						        			<?php //$sumAdv=mysqli_query($connect,"SELECT SUM(advrs) as sumADV FROM `jcb_adv` WHERE cr_id='$cr_id'");
