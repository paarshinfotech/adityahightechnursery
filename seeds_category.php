...
<div class="page-wrapper">
	<div class="page-content">
		<h6 class="mb-0 text-uppercase">बियाणे आवक व जावक श्रेणी </h6>
            <a class="btn btn-sm btn-success float-end" href="seeds_add" style="margin-top:-25px;">
                        ...
                        <div class="dataTables_length" id="suppliertbl_length">
                            <label style="display: inline-flex; align-items: center; gap: 5px; ">Show
                                <select name="suppliertbl_length" id="table_Row_Limit"
                                    onchange="ajaxSeedCategory(1)" aria-controls="suppliertbl"
...
<script>
    function ajaxSeedCategory(page = 1, search = '') {
...
<script>
    function ChangePage(page) {
        ...
        ajaxSeedCategory(page, inputValue)
    }
</script>
