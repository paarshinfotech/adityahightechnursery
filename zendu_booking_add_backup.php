					...
					<div class="card-body p-5">
						...
						<form method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 my-2">
                                                ...
                                                <select class="form-select cus_id text-start" id="cus_id" name="name" required>
																		...
																		<option value="<?= $row1['customer_name'] ?>" <?php if($row1['customer_name']== $name) {echo "selected";}?>> 
                                        ...
                                        <div class="col-12 col-md-3">
                                                ...
                                                <select name="subcat_id" id="subcat_id" class="mb-3 form-select"><option>निवडा उपवर्ग</option>	
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_subcategory where pt_id='1'") ?>
																	<?php if ($getcat && mysqli_num_rows($getcat)): ?>
																		<?php while ($getcus=mysqli_fetch_assoc($getcat)):?>
																		<option value="<?= $getcus['subcat_name']?>"<?php if ($getcus['subcat_name']==$subcat_id) {echo "selected";}?>><?= $getcus['subcat_name'] ?></option>
																		<?php endwhile ?>
																	<?php endif ?>
														</select>
                                                </div>
                                        ...
                                        <!--</div>-->
                                                ...
                                                <select name="subcat_id1" id="subcat_id1" class="mb-3 form-select"><option>निवडा उपवर्ग</option>	
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_subcategory where pt_id='1'") ?>
																	<?php if ($getcat && mysqli_num_rows($getcat)): ?>
																		<?php while ($getcus=mysqli_fetch_assoc($getcat)):?>
														            <option value="<?= $getcus['subcat_name']?>"<?php if ($getcus['subcat_name']==$subcat_id1) {echo "selected";}?>><?= $getcus['subcat_name'] ?></option>
																		<?php endwhile ?>
																	<?php endif ?>
														</select>
                                                </div>
										...
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_category where pt_id='2'") ?>
                                                ...
                                                <label for="ysubcat_id" class="form-label">उपवर्ग<span class="text-danger">*</span></label><br>
                                                  ...
                                                  <select name="ysubcat_id" id="ysubcat_id" class="mb-3 form-select"><option>निवडा उपवर्ग</option>	
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_subcategory where pt_id='2'") ?>
																	<?php if ($getcat && mysqli_num_rows($getcat)): ?>
																		<?php while ($getcus=mysqli_fetch_assoc($getcat)):?>
																		<option value="<?= $getcus['subcat_name']?>"<?php if ($getcus['subcat_name']==$ysubcat_id) {echo "selected";}?>><?= $getcus['subcat_name'] ?></option>
																		<?php endwhile ?>
																	<?php endif ?>
														</select>
                                                </div>
                                        ...
                                        <!--</div>-->
                                                ...
                                                <select name="subcat_idy1" id="subcat_idy1" class="mb-3 form-select"><option>निवडा उपवर्ग</option>	
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_subcategory where pt_id='2'") ?>
																	<?php if ($getcat && mysqli_num_rows($getcat)): ?>
																		<?php while ($getcus=mysqli_fetch_assoc($getcat)):?>
																		<option value="<?= $getcus['subcat_name']?>"<?php if ($getcus['subcat_name']==$subcat_idy1) {echo "selected";}?>><?= $getcus['subcat_name'] ?></option>             
																		<?php endwhile ?>
																	<?php endif ?>
														</select>
                                                </div>
					...
					<div class="card-body p-5">
						...
						<form method="post" enctype="multipart/form-data">
										...
										<i class="bx bxs-plus-circle p-1 ms-1 text-success"></i>
                                                ...
                                                <select class="form-select cus_id text-start" id="cus_id" name="name" required>
																		<option value="">ग्राहक निवडा</option>
																		<?php $query = mysqli_query($connect,"select * from customer order by customer_id desc") ?>
																		<?php if ($query && mysqli_num_rows($query)): ?>
																		<?php while ($row1=mysqli_fetch_assoc($query)): ?>
																		<option value="<?= $row1['customer_name'] ?>">
																			<?= $row1['customer_id'] ?> | <?= $row1['customer_name'] ?> (<?= $row1['customer_mobno'] ?>)
																		</option>
																		<?php endwhile ?>
																		<?php endif ?>
										...
										<?php $getcat = mysqli_query($connect,"SELECT * from marigold_subcategory where pt_id='1'") ?>
																	<?php if ($getcat && mysqli_num_rows($getcat)): ?>
																		<?php while ($getcus=mysqli_fetch_assoc($getcat)):?>
																		<option value="<?= $getcus['subcat_name'] ?>"><?= $getcus['subcat_name'] ?></option>
																		<?php endwhile ?>
																	<?php endif ?>
														</select>
                                                </div>
