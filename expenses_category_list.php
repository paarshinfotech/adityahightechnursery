                        ...
                        <div class="dataTables_length" id="suppliertbl_length">
                            <label style="display: inline-flex; align-items: center; gap: 5px; ">Show
                                <select name="suppliertbl_length" id="table_Row_Limit"
                                    onchange="ajaxExpensesCategoryData(1)" aria-controls="suppliertbl"
...
<script>
    function ajaxExpensesCategoryData(page = 1, search = '') {
        ...
        $.ajax({
            type: "POST",
            url: "ajax_expenses_category_list",
            data: {
...
function ChangePage(page){
	...
	ajaxExpensesCategoryData(page, inputValue )
}
</script>
...
<script>
    function logInputValueCustomer() {
        ...
        ajaxExpensesCategoryData(1, inputValue);
    }
</script>
