				    ...
				    <div id="content m-0">
                                <div id="background">
    	                            ...
    	                            <table class="table table-bordered text-center fs-6">
                                        ...
                                        <!--</tr>-->
                                        <!--    <tr align="right">-->
                                        <!--          <th colspan="4">Date & Grand Total</th>-->
                                        <!--          <td class="text-center">Date: <?//= date('d M Y',strtotime($advdate))?>, ₹ <?//= $amt?>/-</td>-->
                                        <!--</tr>-->
                                        <tr align="right">
                                        ...
                                        <tr align="right">
                                                  <th colspan="4">पुन्हा ऍडव्हान्स रक्कम</th>
                                                  <td class="text-center">
                                                      ₹ <?= $advance?>/-
                                                  </td>
                                        </tr>
                                        <tr align="right">      
                                                  <th colspan="4">बाकी रक्कम</th>
                                                  <td class="text-center">
                                                    ₹ <?= $balance?>/-
