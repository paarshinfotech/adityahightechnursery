...
$getZendu = "SELECT * FROM seeds_sales WHERE sale_id='{$_GET['sid']}'";
                                ...
                                <div id="background">
    	                            ...
    	                            <table class="table table-bordered text-center fs-6">
                                            ...
                                            <tbody>
                                                ...
                                                if(isset($_GET['sid'])):
                                                $getcuspro = "SELECT * FROM seeds_sales_details s INNER JOIN product p ON p.product_id=s.pid INNER JOIN seeds_sales d ON s.sale_id=d.sale_id WHERE s.sale_id='{$_GET['sid']}'";
