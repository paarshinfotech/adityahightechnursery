...
//     // }
//      $delete = mysqli_query($connect, "UPDATE jcb_category SET jcb_cat_status='0' WHERE jcb_cat_id='{$dir}'");
//     }
//         if($delete){
//     	header("Location: jcb_category_list?action=Success&action_msg=जेसीबी श्रेणी हटवले..!");
// 		exit();
//         }else{
...
<div class="page-wrapper">
	<div class="page-content">
		<h6 class="mb-0 text-uppercase">जेसीबी श्रेणी </h6>
            <a class="btn btn-sm btn-success float-end" href="jcb_add" style="margin-top:-25px;">
                        ...
                        <div class="dataTables_length" id="suppliertbl_length">
                            <label style="display: inline-flex; align-items: center; gap: 5px; ">Show
                                <select name="suppliertbl_length" id="table_Row_Limit"
                                    onchange="ajaxJCBCatgory(1)" aria-controls="suppliertbl"
...
<script>
    function ajaxJCBCatgory(page = 1, search = '') {
...
function ChangePage(page){
	...
	ajaxJCBCatgory(page, inputValue )
}
</script>
